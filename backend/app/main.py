...
from app.api import auth, player, inventory, pets, shop, battles, debug, dev, pvp, websocket as pvp_websocket, chat, highscores
...
app.include_router(highscores.router, prefix="/api", tags=["Highscores"])
